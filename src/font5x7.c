...
/*
    Standard 5x7 bitmap font, column-major format.
    Each character is 5 bytes (one per column). In each byte,
...
static const uint8_t blank_glyph[5] = { 0x00, 0x00, 0x00, 0x00, 0x00 };
